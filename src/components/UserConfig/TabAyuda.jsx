  ...
  return (
    <div className="animate-fade-in">
      ...
      >
        ...
        <div>
          ¿Tienes un problema con una solicitud o equipo? Nuestro equipo está
          aquí para ayudarte.
        </div>
      </div>
      ...
      <div className="accordion mb-4" id="accordionFAQ">
        <div className="accordion-item border-0 mb-2 shadow-sm rounded">
          <h2 className="accordion-header">
            <button
              className="accordion-button collapsed rounded fw-bold text-dark"
              type="button"
          ...
          >
            <div className="accordion-body text-muted">
              Asegúrate de borrar tus datos personales y empaquetarlos en cajas
              seguras para el transporte.
            </div>
          </div>
        </div>
        <div className="accordion-item border-0 mb-2 shadow-sm rounded">
          ...
          >
            <div className="accordion-body text-muted">
              Normalmente revisamos las solicitudes en un plazo de 48 a 72 horas
              hábiles.
            </div>
          </div>
        </div>
