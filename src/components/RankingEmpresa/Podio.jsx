    ...
    return (
        <div className="row align-items-end text-center mb-5 gy-4 gx-md-4 mt-5">
            ...
            <div className="col-12 col-md-4 order-2 order-md-1">
                <div className="position-relative p-3 py-4 py-md-5 bg-white rounded-4 rounded-md-top-4 shadow border-top border-4 border-secondary">
                    ...
                    <h5 className="text-primary fw-bold text-wrap mb-0">{nombre2 || "..."}</h5>
            ...
            <div className="col-12 col-md-4 order-1 order-md-2 z-1">
                <div className="position-relative p-3 py-5 bg-white rounded-4 rounded-md-top-4 shadow border-top border-4 border-warning">
            ...
            <div className="col-12 col-md-4 order-3">
                <div className="position-relative p-3 py-4 bg-white rounded-4 rounded-md-top-4 shadow border-top border-4 border-danger">
                    ...
                    <h5 className="text-primary fw-bold text-wrap mb-0">{nombre3 || "..."}</h5>
